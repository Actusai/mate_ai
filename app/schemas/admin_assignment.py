...
class AdminAssignmentBase(BaseModel):
    company_id: conint(gt=0) = Field(..., description="ID of the company this admin supports")
    admin_user_id: conint(gt=0) = Field(..., description="User ID of the admin (must have role 'admin')")
